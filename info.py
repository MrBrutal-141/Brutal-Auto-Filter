...
START_IMG = environ.get('START_IMG', 'https://envs.sh/wK-.jpg')
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "a7a244ba23df6f62417fd25a3751b27a70c220b7")
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002236540396')) #Movie Auto Udpate Channel
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = True
URL = environ.get("URL", "managing-reindeer-geekynetwork-bb0288e1.koyeb.app")
