class script(object):
  ...
  Iᴛ's Bʀᴜᴛᴀʟ ʜᴇʀᴇ ᴛʜᴇ ʙᴇꜱᴛ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ʟᴀᴛᴇꜱᴛ ꜰᴇᴀᴛᴜʀᴇꜱ. \n
ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴀɴʏ ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ ᴏʀ ᴀɴɪᴍᴇ ᴡɪᴛʜɪɴ 1 ꜱᴇᴄᴏɴᴅ ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ɴᴀᴍᴇ ᴏꜰ ʏᴏᴜʀ ᴅᴇꜱɪʀᴇᴅ ᴍᴏᴠɪᴇ ᴀɴᴅ ꜱᴇᴇ ᴍʏ ᴍᴀɢɪᴄ. \n
<a href="https://t.me/MisterBrutal/21"> ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ʀᴇᴀᴅ ᴍʏ ᴄᴏᴍᴍᴀɴᴅꜱ</a>
</b>"""
...
ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ🍿</b>'''

    
    REF_LINK = '''🔗 <b>Hᴇʀᴇ ɪs ᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ 👇
   ➥ ʟɪɴᴋ: <code>https://telegram.me/{}?start=biisal-{}</code>
...
Yᴏᴜʀ <u>ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ</u> ᴡɪʟʟ ʙᴇ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ᴀғᴛᴇʀ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ</b>"""
...
➥ ʏᴏᴜ ʜᴀᴠᴇ ᴀᴛʟᴇᴀsᴛ ᴏɴᴇ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ.
...
GROUP_RULES = """ <b>
    ❗Rᴇᴀᴅ Tʜᴇsᴇ Rᴜʟᴇs Cᴀʀᴇғᴜʟʟʏ Bᴇғᴏʀᴇ Sᴇᴀʀᴄʜɪɴɢ Aɴʏ Mᴏᴠɪᴇ.

1. Oᴘᴇɴ Gᴏᴏɢʟᴇ Aɴᴅ Sᴇᴀʀᴄʜ Yᴏᴜʀ Dᴇsɪʀᴇ Mᴏᴠɪᴇ/Wᴇʙsᴇʀɪᴇs Nᴀᴍᴇ.

2. Tʜᴇɴ Cᴏᴘʏ Nᴀᴍᴇ Oғ Yᴏᴜʀ Dᴇsɪʀᴇᴅ Mᴏᴠɪᴇ Aɴᴅ Pᴀsᴛᴇ Iᴛ Iɴ Gʀᴏᴜᴘ.
...
🔍 Sᴇᴀʀᴄʜ Wᴇʙsᴇʀɪᴇs Lɪᴋᴇ Tʜɪs👇

Pᴀɴᴄʜᴀʏᴀᴛ S01 ✅
Pᴀɴᴄʜᴀʏᴀᴛ S01E04 ✅
Pᴀɴᴄʜᴀʏᴀᴛ S02 E02 ✅
Pᴀɴᴄʜᴀʏᴀᴛ Sᴇᴀsᴏɴ 02 ❌
Pᴀɴᴄʜᴀʏᴀᴛ Eᴘɪsᴏᴅᴇ 05 ❌
...
Exᴀᴍᴘʟᴇ: 
#request  Aᴠᴀᴛᴀʀ 2009 Hɪɴᴅɪ </b> """
DONATE_TXT =  """
<b> ❣️ Tʜᴀɴᴋs Fᴏʀ Sʜᴏᴡɪɴɢ Yᴏᴜʀ Iɴᴛᴇʀᴇsᴛ Bᴜᴅᴅʏ.❣️
